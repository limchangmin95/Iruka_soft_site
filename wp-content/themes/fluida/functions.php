...
function responsive_styles() {
	wp_enqueue_style('responsive-style', get_theme_file_uri( '/resources/styles/responsive.css' ), array());
}
...
function function_script() {
	wp_enqueue_script( 'function-js', get_theme_file_uri( '/resources/js/function.js' ), array());
}

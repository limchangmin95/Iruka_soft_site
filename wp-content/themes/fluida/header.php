...
<html <?php language_attributes(); ?>>
    <head>
        ...
        <link
            rel="pingback"
            href="<?php echo esc_url( get_bloginfo( 'pingback_url' ) ); ?>">
        <?php endif; ?>
        <?php
	cryout_header_hook();
	wp_head();
    ...
    <body <?php body_class(); cryout_schema_microdata( 'body' );?>>
        ...
        <div id="site-wrapper">
            ...
            <header
                id="masthead"
                class="cryout"
                <?php cryout_schema_microdata( 'header' ) ?>>
                ...
                <div id="site-header-main">
                    <div id="site-header-main-inside">
                        ...
                        <nav id="mobile-menu">
                            ...
                            <button id="nav-cancel">
                                <i class="blicon-cross3"></i>
                            </button>
                        </nav>
                        <!-- #mobile-menu -->
                        <?php } ?>
                        ...
                        <nav
                            ...
                            <?php cryout_schema_microdata( 'menu' ); ?>>
